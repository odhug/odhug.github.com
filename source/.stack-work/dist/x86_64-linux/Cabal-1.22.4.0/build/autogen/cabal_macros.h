...
/* package errors-2.0.1 */
#define VERSION_errors "2.0.1"
#define MIN_VERSION_errors(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  0 || \
  (major1) == 2 && (major2) == 0 && (minor) <= 1)

/* package hakyll-4.7.3.0 */
#define VERSION_hakyll "4.7.3.0"
#define MIN_VERSION_hakyll(major1,major2,minor) (\
  (major1) <  4 || \
  (major1) == 4 && (major2) <  7 || \
  (major1) == 4 && (major2) == 7 && (minor) <= 3)
...
/* package monads-tf-0.1.0.2 */
#define VERSION_monads_tf "0.1.0.2"
...
/* package pandoc-1.15.0.6 */
#define VERSION_pandoc "1.15.0.6"
...
#define CURRENT_PACKAGE_KEY "odhug_H8Vv4bQVprz4m6Xvzb0W6d"
